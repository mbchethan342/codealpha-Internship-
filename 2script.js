...
let calTime; // Declare calTime globally
...
function calculate() { // Corrected function name
    disBlock.style.display = 'block';
    let dobVal = dobDate.value;

    dob = new Date(dobDate.value); // Reassign the global variable dob
    console.log(dob);
    ...
    age.innerHTML = "You are  <br>" + year + "Year" + "Months" + day + "Days,";

    calTime = setInterval(samay, 1000);
}

calcBtn.onclick = calculate; // Corrected function name
